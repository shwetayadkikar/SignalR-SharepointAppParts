...
namespace SharePointPollAppWeb
{
    /// <summary>
    ...
    public abstract class SharePointContextProvider
    {
        ...
        /// <summary>
        /// Gets a SharePointContext instance associated with the specified HTTP context and Host Web Url
        /// </summary>
        /// <param name="httpContext">The HTTP context</param>
        /// <param name="spHostUrl">Host Web Url</param>
        /// <returns>The SharePointContext instance. Returns <c>null</c> if not found and a new instance can't be created.</returns>
        public SharePointContext GetSharePointContext(HttpContextBase httpContext, string spHostUrl)
        {
            if (httpContext == null)
            {
                throw new ArgumentNullException("httpContext");
        ...
        /// <summary>
        /// Validates if the given SharePointContext can be used with the specified HTTP context and host web url
        /// </summary>
        /// <param name="spContext">The SharePointContext</param>
        /// <param name="httpContext">The HTTP context</param>
        /// <param name="spHostUrl">Host Web Url</param>
        /// <returns>True if the given SharePointContext can be used with the specified HTTP context.</returns>
        protected abstract bool ValidateSharePointContext(SharePointContext spContext, HttpContextBase httpContext, string spHostUrl);
    ...
    public class SharePointAcsContextProvider : SharePointContextProvider
    {
        ...
        protected override bool ValidateSharePointContext(SharePointContext spContext, HttpContextBase httpContext, string hostUrl)
        {
            SharePointAcsContext spAcsContext = spContext as SharePointAcsContext;
